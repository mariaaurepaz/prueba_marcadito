...
export class Pedidos extends Entity {
  ...
  @property({
    ...
    required: false,
    length: 50,
    mssql: {columnName: 'fecha_emision', dataType: 'nvarchar', dataLength: 50, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  fechaEmision?: string;
  ...
  @property({
    ...
    required: false,
    length: 50,
    mssql: {columnName: 'fecha_entrega', dataType: 'nvarchar', dataLength: 50, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  fechaEntrega?: string;
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mssql: {columnName: 'monto_total', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'YES'},
  })
  montoTotal?: number;
